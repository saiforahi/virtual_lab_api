...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    schedule = serializers.IntegerField(required=True,error_messages={'required':'schedule is required'})
    ...
    def create(self, validated_data):
        new_project = Project.objects.create(owner_id=validated_data['owner'].id,name=validated_data['name'],schedule=validated_data['schedule'])
